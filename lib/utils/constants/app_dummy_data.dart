...
import 'package:ozon_store/routes/routes.dart';
import 'package:ozon_store/utils/constants/image_strings.dart';

class AppDummyData {
  static final List<BannerModel> banners = [
    BannerModel(imageUrl: AppImages.banner1, targetScreen: RoutesStrings.order, active: false),
    BannerModel(imageUrl: AppImages.banner2, targetScreen: RoutesStrings.cart, active: true),
    BannerModel(imageUrl: AppImages.banner3, targetScreen: RoutesStrings.favourites, active: true),
    BannerModel(imageUrl: AppImages.banner4, targetScreen: RoutesStrings.search, active: true),
    BannerModel(imageUrl: AppImages.banner5, targetScreen: RoutesStrings.settings, active: true),
    BannerModel(imageUrl: AppImages.banner6, targetScreen: RoutesStrings.userAddress, active: true),
    BannerModel(imageUrl: AppImages.banner8, targetScreen: RoutesStrings.checkout, active: false),
  ];
